...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default=os.getenv("ORIKA_OUTPUT_DIR", "orika_live_output"), help="Directory for JSONL/CSV output")
    parser.add_argument("--snapshot-interval", type=int, default=int(os.getenv("ORIKA_SNAPSHOT_INTERVAL", "300")), help="CSV snapshot interval seconds")
